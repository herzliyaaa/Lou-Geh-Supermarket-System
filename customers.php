...
<head>
    ...
    <title>Lou Geh Supermarket/ Customers</title>
</head>
                    ...
                    <div class="modal-form">
                        <form action="add-customer.php" method="post" style="width: 20rem;">
                            ...
                            <div class="py-2 d-flex justify-content-end align-items-end">
                                <button type="submit" name="add_customer" class="primary-btn">SAVE</button>
                            </div>
                        </form>
                    </div>
                </div>
    ...
    <div>
        <div class="d-flex p-3 m-0 justify-content-center" style="flex-direction: column;">
            <div class='d-flex p-1 justify-content-end align-items-end'>
                <button class='primary-btn' id="myBtn">ADD CUSTOMER</button>
            </div>
            ...
            <div class='item-table-container'>
                <table id="example" style="width: 100%;" class="display">
                    ...
                    <tbody>
                        ...
                        while ($row = mysqli_fetch_array($customers_query)) {
                        ?>
                            <tr>
                                ...
                                <td style="text-align: center;">
                                    <a class="edit-btn" href="customer-details.php?customer_id=<?php echo $row['customer_id'] ?>">
